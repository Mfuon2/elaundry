            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="#" onclick="editUsers.init();editUsers.formName();clearDiv()"><i
                                class="fa fa-circle-o"></i>User Activation</a></li>
                        <li class="active"><a href="#" onclick="listUsers.list();"><i
                                class="fa fa-circle-o"></i>List Users</a></li>
                        <li class="active"><a href="#" onclick="clients.init();clients.formName();clearDiv()"><i
                                class="fa fa-circle-o"></i>Edit Clients</a></li>
                        <li class="active"><a href="#" onclick="technician.init();technician.formName();clearDiv()"><i
                                class="fa fa-circle-o"></i>Edit Technicians</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="#" onclick="ticket.init();ticket.formName();clearDiv()"><i
                                class="fa fa-circle-o"></i>All Issues</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="#" onclick="searchPerson();clearDiv()"><i
                                class="fa fa-circle-o"></i>Raised Issues</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-xs-6">
                                        ...
                                        <div class="small-box bg-aqua">
                                            ...
                                            <a class="small-box-footer" href="#"
                                               onclick="ticket.init();ticket.formName();clearDiv()">View Tickets<i
                                    ...
                                    <div class="col-lg-3 col-xs-6">
                                        ...
                                        <div class="small-box bg-green">
                                            ...
                                            <a class="small-box-footer" href="#" onclick="searchPerson();clearDiv()">
                                                View Open Tickets<i class="fa fa-arrow-circle-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- ./col -->
                                    <div class="col-lg-3 col-xs-6">
                                        ...
                                        <div class="small-box bg-yellow">
                                            ...
                                            <a class="small-box-footer" href="#"
                                               onclick="editUsers.init();editUsers.formName();clearDiv()"> Activte Users
                                    ...
                                    <div class="col-lg-3 col-xs-6">
                                        ...
                                        <div class="small-box bg-red">
                                            ...
                                            <a class="small-box-footer" href="#">ytyt<i
                                                    class="fa fa-arrow-circle-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- ./col -->
...
<script src="js/app/mapUsers.js"></script>
